            ...
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
                <div class="login-form">
                    ...
                    <form name="form" method="post">
                        ...
                        <div class="form-group<?php if ($errorMsgEmail != '') echo ' has-error'; ?>">
                            ...
                            <input type="email" name="email" autocomplete="false"
                                   value="<?php echo htmlspecialchars($userDetails->email, ENT_QUOTES, 'UTF-8'); ?>"
                                   class="form-control" placeholder="Email" required>
                        </div>

                        <div class="form-actions form-group ">
                            <input type="submit" name="update_info_submit" class="pri_button full-width" value="Save">
                        </div>
                    </form>
                    ...
                    <form name="form" method="post">
                        ...
                        <div class="form-actions form-group ">
                            <input type="submit" name="change_password_submit" class="pri_button full-width"
                                   value="Change">
                        </div>
